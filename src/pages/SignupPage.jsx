        ...
        <>
            {
                ...
                </svg> : <> <div className="text-5xl text-center mt-[10vh] font-extrabold text-purple">Sign Up</div> <img className='p-32 mt-18' src="src\assets\auth.svg" alt="" /></>
            }
                ...
                <div className="w-full flex justify-center fixed bottom-[3vw]">
                    <div className="authBox">
                        ...
                        <form className="flex flex-col gap-3 mt-2">
                            ...
                            <div className=" flex justify-center">Already have an account? <p className='text-purple ml-1 hover:underline hover:cursor-pointer text-nowrap
                            '> Sign in</p></div>
                        </form>
                    </div>
                </div >
