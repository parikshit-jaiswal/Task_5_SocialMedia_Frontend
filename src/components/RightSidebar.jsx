        ...
        <div className="flex justify-end">
            <div className='w-[28vw] pr-7 mt-[10rem]'>
                ...
                <div className="h-fit w-full border-[5px] rounded-3xl border-[#bbacf2] mt-5 pb-5">
                    ...
                    <div className="liveUsers flex mt-5 overflow-x-scroll">
                        <div className="user ml-3 flex-col justify-center items-center">
                            <div className="w-[4.8rem] h-[4.8rem] flex justify-center items-center border-4 border-[#6c60a0] rounded-[100%]  ]">
                                <img className=' w-[4rem] h-[4rem] bg-white rounded-[100%] object-cover' src="https://plus.unsplash.com/premium_photo-1669882305273-674eff6567af?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                            </div>
                            <p className='text-center mt-2'>@ArickS</p>
                        </div>
                        <div className="user ml-5 flex-col justify-center items-center">
                            <div className="w-[4.8rem] h-[4.8rem] flex justify-center items-center border-4 border-[#6c60a0] rounded-[100%]  ]">
                                <img className=' w-[4rem] h-[4rem] bg-white rounded-[100%] object-cover' src="https://plus.unsplash.com/premium_photo-1669882305273-674eff6567af?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                            </div>
                            <p className='text-center mt-2'>@ArickS</p>
