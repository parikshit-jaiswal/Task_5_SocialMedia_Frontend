                    ...
                    {suggestedUsers.map((suggestedUser) => {
                        return (
                            <div key={uuidv4()} className="friend flex justify-between items-center px-1 mt-5">
                                <div className="flex items-center gap-4"><img className='h-[4rem] w-[4rem] rounded-[100%] object-cover' src={suggestedUser?.profileImage?.url} alt="" />
                                    <p className='text-xl'>{suggestedUser?.userName}</p></div>
