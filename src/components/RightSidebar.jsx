            ...
            <div className="w-[28vw] pr-7 mt-[10rem]">
                ...
                <div className="addFriend">
                    ...
                    {suggestedUsers?.map((suggestedUser) => (
                        <div key={suggestedUser?.userName} className="friend flex justify-between items-center px-1 mt-5">
                            <div className="flex items-center gap-4">
                                <img
                                    className="h-[4rem] w-[4rem] rounded-[100%] object-cover"
                                    src={suggestedUser?.profileImage?.url}
                                    alt="Suggested user"
                                    loading="lazy"
                                />
                            ...
                            {following?.some((follow) => follow.userName === suggestedUser.userName) ? (
                                <button
                                    onClick={() => unFollowHandler(suggestedUser.userName)}
                                ...
                                <button
                                    onClick={() => followHandler(suggestedUser.userName)}
                                    className="opacity-70 cursor-pointer hover:opacity-100"
                                >
